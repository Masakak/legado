...
import io.legado.app.data.dao.AudioChapterCacheDao
...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        RuleSub::class, DictRule::class, KeyboardAssist::class, Server::class, AudioChapterCache::class],
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val audioChapterCacheDao: AudioChapterCacheDao
